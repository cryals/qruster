...
- [`frontend/src/main.tsx`](../../../../../frontend/src/main.tsx) монтирует приложение и применяет MUI theme
- [`frontend/src/App.tsx`](../../../../../frontend/src/App.tsx) владеет основным экраном и верхнеуровневым state
...
Определён в [`backend/src/main.rs`](../../../../../backend/src/main.rs):
...
Все extractor-ы реализуют `MediaExtractor` из [`backend/src/extractors/mod.rs`](../../../../../backend/src/extractors/mod.rs).
